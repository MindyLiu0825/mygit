...
<body>
	...
	<div class="container register">
	    <div class="span24" style="color:red;">
                    ...
                    <article class="row">
                        ...
                        <section class="col-xs-9">
                            <form id="registerForm" method="post" role="form" class="form-horizontal"
                                ...
                                <div class="form-group">
                                    <div class="col-xs-2">
                                        <label><span class="requiredField">*</span>密&nbsp;&nbsp;码:</label>
                                    </div>
                                    <div class="col-xs-5">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-2">
                                        <label><span class="requiredField">*</span>确认密码:</label>
                                    </div>
                                    <div class="col-xs-5">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-2">
                                        <label><span class="requiredField">*</span>E-mail:</label>
                                    </div>
                                    <div class="col-xs-5">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-2">
                                        <label><span class="requiredField">*</span>验证码:</label>
                                    </div>
                                    <div class="col-xs-5">
                                        <div class="col-xs-5">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12 col-xs-offset-2">
                                        <input type="submit" class="btn btn-danger" value="同意以下协议并注册" id="regBtn">
                                        <input type="reset" id="resBtn" class="btn btn-danger" />
                                    </div>
                                </div>
                        ...
                        <section class="col-xs-2">
                            <div class="login">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        立即登录即可体验在线购物！ <a
                                            href="${pageContext.request.contextPath}/user/loginInit.action">立即登录</a>
                                    </dd>
                                </dl>
                            </div>
                        </section>
