...
<head>
    ...
    <script type="application/javascript" language="JavaScript" src="${pageContext.request.contextPath}/js/jquery-1.11.1.min.js"></script>
    <script type="application/javascript" language="JavaScript" src="${pageContext.request.contextPath}/js/bootstrap.js"></script>
   ...
   <article class="row">
       <section  class=" col-xs-7">
           ...
           <div id="carousel_container" class="carousel slide"   data-ride="carousel">
               ...
               <div class="carousel-inner">
                   <div class="item"> <img src="${pageContext.request.contextPath}/image/banner01.jpg" ></div>
                   <div class="item active"> <img src="${pageContext.request.contextPath}/image/banner02.jpg"></div>
                   <div class="item"> <img src="${pageContext.request.contextPath}/image/banner03.jpg"></div>
                   <div class="item"> <img src="${pageContext.request.contextPath}/image/banner04.jpg" ></div>
               </div>
           ...
           <div style="width: 555px; height: 110px; background-color: antiquewhite"></div>

       </section>
       <section class="col-xs-5" style="margin-left: 0px;" >
           <img src="${pageContext.request.contextPath}/images/main/phone.jpg">
       </section>
   </article>
        ...
        <div id="hotProduct" class="hotProduct clearfix">
            ...
            <ul class="tabContent" style="display: block;">
                <c:forEach items="${hots}" var="hot">
                    <li>
                        <a target="_blank" href="${pageContext.request.contextPath}/product/list.action?pid=${hot.pid}"><img src="${pageContext.request.contextPath}/image/${hot.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/0ff130db-0a1b-4b8d-a918-ed9016317009-thumbnail.jpg" style="display: block;"></a>
                    </li>
                </c:forEach>
    ...
    <div class="span24">
        <div id="newProduct" class="newProduct clearfix">
            ...
            <ul class="tabContent" style="display: block;">
                <c:forEach items="${news}" var="_new">
                    <li>
                        <a  target="_blank"><img src="${pageContext.request.contextPath}/image/${_new.image}" data-original="http://storage.shopxx.net/demo-image/3.0/201301/4a51167a-89d5-4710-aca2-7c76edc355b8-thumbnail.jpg" style="display: block;"></a>									</li>
