                    ...
                    <table>
                        <tbody><tr>
                            ...
                            <td>
                                ...
                                <span class="checmessage" id="message_username"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="password" id="password" name="password" class="text" maxlength="20" required>
                                <span class="checmessage" id="message_password"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="password" name="repassword" class="text" maxlength="20" autocomplete="off" required="required">
                                <span class="checmessage" id="message_repassword"></span>
                            </td>
                        </tr>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="fieldSet">
                                    <input type="text" id="captcha" name="captcha" class="text captcha" maxlength="4" autocomplete="off" required="required">
                                      <img  id="captchaImage"
                                            class="captchaImage"
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="button" class="submit" value="同意以下协议并注册" id="regBtn">
                            </td>
                        </tr>
                        <tr>
                            <th>&nbsp;
