    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm"  method="post" action="${pageContext.request.contextPath}/user/regist.action" style="font-size: 14px;">
                    <table>
                        <tbody>
                        <tr>
                            <th>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="email" id="email" name="email" class="text" placeholder="xxx@xx.com">
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <input type="tel" id="phone" name="phone" class="text"  required="required" placeholder="11位数字" minlength="11">
                            </td>
                        </tr>
                        <tr>
                            <th>姓名:</th>
                    ...
                    <div class="login">
                        ...
                        <dd>
                            立即登录即可体验在线购物！
                            <a href="${pageContext.request.contextPath}/user/loginInit.action">立即登录</a>
                        </dd>
                    </dl>
                    </div>
                </form>
